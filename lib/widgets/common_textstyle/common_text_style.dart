...
class CommonTextStyle {
  static TextStyle style7font16weight700black = const TextStyle(
      color: Colors.black,
      letterSpacing: 0.4,
      fontSize: 24,
  ...
  static TextStyle lawScreenText = const TextStyle(
      color: Colors.black,
      letterSpacing: 0.4,
      fontSize: 18.33,
      fontWeight: FontWeight.w700,
      fontFamily: 'Nexa');
  static TextStyle lawNameText = const TextStyle(
      color: Colors.black,
      letterSpacing: 0.1,
      fontSize: 12,
      fontWeight: FontWeight.w600,
      fontFamily: 'Nexa');
  static TextStyle lawDefineName = const TextStyle(
      color: Colors.black,
      letterSpacing: 0.1,
      fontSize: 12,
  ...
  static TextStyle lawStatusText = const TextStyle(
      color: Colors.black,
      letterSpacing: 0.4,
      fontSize: 11,
      fontWeight: FontWeight.w600,
  ...
  static TextStyle font16greycolor = const TextStyle(
  ...
  static TextStyle BlueColorBold = const TextStyle(
      color: Colors.black,
      letterSpacing: 0.4,
      fontSize: 14,
      fontWeight: FontWeight.w700,
  ...
  static TextStyle dialogBoxText = const TextStyle(
      ...
      fontWeight: FontWeight.normal,
      fontFamily: 'Nexa');
  static TextStyle fontsColor = const TextStyle(
      color: AppColors.blackColor,
      fontSize: 16,
      fontWeight: FontWeight.normal,
      fontFamily: 'Nexa');
  static TextStyle storeNormalColor = const TextStyle(
      color: Color(0xff686868),
      fontSize: 12,
      fontWeight: FontWeight.normal,
      fontFamily: 'Nexa');

  static TextStyle followFollowersTitle = const TextStyle(
      color: Color(0xff333333),
      fontSize: 16,
      fontWeight: FontWeight.w400,
      fontFamily: 'Nexa');

  static TextStyle followAndUnfollowBtnStyle = const TextStyle(
      color: Color(0xff316FF6),
      fontSize: 14,
      fontWeight: FontWeight.normal,
      fontFamily: 'Nexa');
  static TextStyle dialogBoxColor = const TextStyle(
      color: Color(0xff5C5C5C),
      fontSize: 12,
      // fontWeight: FontWeight.normal,
      fontFamily: 'Nexa');

  static TextStyle authEmailBold = const TextStyle(
      color: AppColors.blackColor,
      letterSpacing: 0.4,
      fontSize: 18,
      fontWeight: FontWeight.bold,
  ...
  static TextStyle greyText = const TextStyle(
    ...
    static TextStyle grey12Text = const TextStyle(
    color: AppColors.subtitleText,
    letterSpacing: 0.4,
    fontSize: 12,
    fontWeight: FontWeight.w400,
 ...
 static TextStyle lightGreySubTitle = const TextStyle(
  ...
  static TextStyle white24Title = const TextStyle(
      color: Colors.white,
      letterSpacing: 0.4,
      fontSize: 24,
      fontWeight: FontWeight.w400,
  ...
  static TextStyle white12Title = const TextStyle(
      color: Colors.white,
      letterSpacing: 0.4,
      fontSize: 12,
      fontWeight: FontWeight.w400,
